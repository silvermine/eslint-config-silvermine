   ...
   rules: {
      ...
      '@stylistic/type-annotation-spacing': [
         'error',
         {
            ...
            'after': true,
            'overrides': {
               // This option is deprecated, but @stylistic offers no replacement.
               // Removing this causes @stylistic/type-annotation-spacing' to enforce
               // arrow functions with spacing like this: `()=> {}` (Note the missing
